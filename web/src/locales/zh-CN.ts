export default {
  ...
  keys: {
    ...
    allowedUserAgents: "允许的User-Agent",
    allowedUserAgentsTooltip: "只允许列表中的User-Agent访问，每行一个。如果为空，则允许所有User-Agent。",
    allowedUserAgentsPlaceholder: "输入允许的User-Agent，每行一个",
    never: "从未",
    daysAgo: "{days}天前",
    hoursAgo: "{hours}小时前",
