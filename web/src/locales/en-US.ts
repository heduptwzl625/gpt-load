export default {
  ...
  keys: {
    ...
    allowedUserAgents: "Allowed User-Agents",
    allowedUserAgentsTooltip:
      "Only allow User-Agents in the list to access, one per line. If empty, all User-Agents are allowed.",
    allowedUserAgentsPlaceholder: "Enter allowed User-Agents, one per line",
    never: "Never",
